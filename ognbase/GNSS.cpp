...
#if 0
/* https://forum.arduino.cc/t/gps-module-power-management/477859/8 */
const uint8_t SW_BACKUP[16] PROGMEM =     {0xB5, 0x62, 0x06, 0x57, 0x08, 0x00,
                                           0x01, 0x00, 0x00, 0x00, 0x50, 0x4B,
                                           0x43, 0x42, 0x86, 0x46);

// same as RXM_PMREQ_OFF above:
const uint8_t RXM_PMREQ[16] PROGMEM =     {0xb5, 0x62, 0x02, 0x41, 0x08, 0x00,
                                           0x00, 0x00, 0x00, 0x00, 0x02, 0x00,
                                           0x00, 0x00, 0x4d, 0x3b};   //power off until wakeup call
#endif

const uint8_t    GPSon[16] PROGMEM =      {0xB5, 0x62, 0x02, 0x41, 0x08, 0x00,
